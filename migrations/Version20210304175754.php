 ...
 */
final class Version20210304175754 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE image (id INT AUTO_INCREMENT NOT NULL, visit_id INT DEFAULT NULL, answer_id INT DEFAULT NULL, filename VARCHAR(255) NOT NULL, INDEX IDX_C53D045F75FA0FF2 (visit_id), INDEX IDX_C53D045FAA334807 (answer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE race (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(63) NOT NULL, description LONGTEXT DEFAULT NULL, start_showing_peaks DATETIME NOT NULL, start_logging_peaks DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
